...
const (
	...
	Woodpecker_TaintAgent_FullMethodName      = "/proto.Woodpecker/TaintAgent"
)
...
type WoodpeckerClient interface {
	...
	TaintAgent(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Empty, error)
}
...
func (c *woodpeckerClient) TaintAgent(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
	err := c.cc.Invoke(ctx, Woodpecker_TaintAgent_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type WoodpeckerServer interface {
	...
	TaintAgent(context.Context, *Empty) (*Empty, error)
...
func (UnimplementedWoodpeckerServer) TaintAgent(context.Context, *Empty) (*Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method TaintAgent not implemented")
}
...
func _Woodpecker_TaintAgent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WoodpeckerServer).TaintAgent(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Woodpecker_TaintAgent_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WoodpeckerServer).TaintAgent(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Woodpecker_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "TaintAgent",
			Handler:    _Woodpecker_TaintAgent_Handler,
		},
	},
